...
// Navigate to the registration page and perform registration
    ...
    await registerPage.fillRegistrationForm("Mani", "Rasheed", "mani202020rash@mail.com", "03085369444", "1234mani");
...
// Navigate to the login page and perform login
    ...
    await loginPage.login("mani202020rash@mail.com", "1234mani");
